...
const FooterPage = () => {
  ...
  return (
    <footer className='h-auto text-blue-700 w-full '>
      <hr />
      <div className='px-6 py-6 mx-auto flex items-center sm:flex-row flex-col'>
        ...
        <span className='inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start px-5 text-lg '>
          <a
            className='ml-3 text-blue-700 hover:scale-150 transition-transform duration-300'
            href='mailto:mujibsayyad97@gmail.com'
            target='_blank'
            rel='noreferrer'
          >
            <Svg
              className='bi bi-envelope py-1'
