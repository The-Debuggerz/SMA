...
const Settings = () => {
  ...
  return (
    <>
      ...
      <div className='userDevice-info flex items-center flex-col pb-8'>
        <div className='inline-flex items-center  px-4 py-2 bg- bg-green-700 hover:bg text-white text-sm font-medium rounded-md'>
          <svg
        ...
        <div className='mt-4 text-justify px-4 py-2 bg- bg-green-700 text-white text-lg font-medium rounded-md'>
          <table>
            <thead>
              <tr>
                <th>Device</th>
