...
function AddPost() {
  ...
  <div class='min-w-0 flex-1 px-15 py-15'>
    <form action='#' class='relative'>
      <div class='border border-gray-300 rounded-lg shadow-sm overflow-hidden focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 px-4 py-2'>
        <label for='comment' class='sr-only'>Add your comment</label>
        <textarea rows='4' name='comment' id='comment' class='block w-full py-3 border-0 resize-none focus:ring-0 sm:text-sm '   placeholder='Add your comment...'></textarea>
